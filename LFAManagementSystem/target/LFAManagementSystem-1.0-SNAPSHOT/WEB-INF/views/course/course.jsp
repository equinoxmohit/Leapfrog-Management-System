        ...
        <div class="container">
            ...
            <form action="" method="post">
                <div>
                    ...
                    <input type="text" name="courseName" required="required" class="form-control"/>
                </div>
                <div>
                    <label>Course Description</label>
                    <textarea rows="2" name="courseDescription" required="required" class="form-control"></textarea>
                </div>
                <div>
                    <label>Fees</label>
                ...
                <div>
                    ...
                    <input type="text" name="durationType" required="required" class="form-control"/>
                </div>
                <br>
                <div>
